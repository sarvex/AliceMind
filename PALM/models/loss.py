...
class LossComputeBase(nn.Module):
    ...
    def _make_shard_state(self, batch, output, attns, memory):
        """
    ...
    def monolithic_compute_loss(self, batch, output, attns=None, memory=None):
        """
        ...
        """
        shard_state = self._make_shard_state(batch, output, attns, memory)
    ...
    def sharded_compute_loss(self, batch, output,
                              shard_size,
                             normalization, attns=None, memory=None):
...
class NMTLossCompute(LossComputeBase):
    ...
    def _make_shard_state(self, batch, output, attns=None, memory=None):
    ...
    def _compute_loss(self, batch, output, target, attns=None, memory=None):
        if attns is not None:
            scores = self.generator(batch.src, output, attns, memory)
        else:
